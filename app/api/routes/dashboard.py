...
async def get_dashboard(
    ...
    # Items récents
    recent_items = db.query(LibraryItem)\
    ...
    # Requêtes récentes
    recent_requests = db.query(JellyseerrRequest)\
        .order_by(JellyseerrRequest.created_at.desc())\
...
async def get_requests(
    ...
    requests = db.query(JellyseerrRequest)\
        .order_by(JellyseerrRequest.created_at.desc())\
        .limit(limit)\
        .all()
    return requests
